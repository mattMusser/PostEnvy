...
# added so the create_session(user) can be used
...
# Context for an un-signed-in user
  ...
  # Denies Guests access to the create, new, edit , update,  and destroy actions. They are redirected.
    describe "GET new" do
