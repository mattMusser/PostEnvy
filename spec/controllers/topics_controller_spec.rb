...
RSpec.describe TopicsController, type: :controller do
	...
	context "member user" do
		before do
			user = User.create!(name: "PostEnvy User", email: "user@postenvy.com", password: "helloworld", role: :member)
			create_session(user)
		end
	...
	context "admin user" do
		before do
			user = User.create!(name: "PostEnvy User", email: "user@postenvy.com", password: "helloworld", role: :admin)
			create_session(user)
		end
	...
	context "mod user" do
		before do
			user = User.create!(name: "PostEnvy User", email: "user@postenvy.com", password: "helloworld", role: :mod)
			create_session(user)
		end
